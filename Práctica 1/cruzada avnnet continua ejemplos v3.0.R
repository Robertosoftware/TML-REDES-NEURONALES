...
vardep="cstrength",listconti=c("age","water"),
listclass=c(""),grupos=4,sinicio=1234,repe=5,
size=c(10),decay=c(0.1),repeticiones=5,itera=300)
...
vardep="cstrength",listconti=c("age","water"),
listclass=c(""),grupos=4,sinicio=1234,repe=5,
size=c(15),decay=c(0.0001),repeticiones=5,itera=100)
...
# Ejemplo comparación diferentes modelos, se ve que añadir mejores variables mejora mucho la performance. 
